...
{AGH University}
{Key courses: natural language processing, advanced algorithms, machine learning, multimodal interfaces, computational intelligence, physics.\\
...
{AGH University}
{Key courses: algebra, calculus, speech technology, physics, object-oriented system design, digital signal processing, cognitive robotics.\\
...
{Programming}
{}
{Python, Keras, TensorFlow, R, Spark, C++}
\entry
{}
{Expertise}
{}
...
{Languages}
{}
{Polish (native), English (fluent), Spanish (good), German (good)}
\end{entrylist}
